    ...
    <div>
      ...
      >
        <div className="container px-2">
          ...
          >
            <span className="text-slate-200 xl:text-slate-700">
              Чаму менавіта
            </span>{" "}
          ...
          <div className="grid justify-items-start overflow-hidden rounded-xl bg-slate-100/70 text-slate-900 md:grid-cols-2 md:grid-rows-2 md:gap-9 md:py-10 md:px-20">
            ...
            >
              ...
              <p className="text-base font-medium text-slate-900 md:text-2xl">
                Індывідуальны падыход і празрыстасць умоў
              </p>
            </div>
            ...
            >
              ...
              <p className="text-base font-medium text-slate-900 md:text-2xl">
                Майстэрства і прафесіяналізм на ўсіх этапах работы
              </p>
            </div>
            ...
            >
              ...
              <p className="text-base font-medium text-slate-900 md:text-2xl">
              3 гады вопыту ў сферы легалізацыі знаходжання і іміграцыі
              </p>
            </div>
          </div>
