      ...
      >
        <div className="container ">
          <h2
            ref={h2s6Ref1}
            className={`${
              h2s6IsVisible1 ? "animate-fadeIn animate-delay-300 opacity-100" : " opacity-0"
            } transition-opacity text-center text-3xl font-bold text-slate-100 md:text-6xl`}
          >
            Наші послуги
          </h2>
          ...
          <div className="flex flex-col items-center justify-center gap-7 pt-10 lg:flex-row lg:items-stretch lg:gap-5">
            ...
            <div
              ...
              className={`${
                priceCardIsVisible1
                  ? "animate-fadeInLeft animate-delay-300 opacity-100" : " opacity-0"
            ...
            <div
              ref={priceCardRef2}
              className={`${
                priceCardIsVisible2 ? "animate-fadeIn animate-delay-300 opacity-100" : " opacity-0"
            ...
            <div
              ...
              className={`${
                priceCardIsVisible3
                  ? "animate-fadeInRight animate-delay-300 opacity-100" : " opacity-0"
